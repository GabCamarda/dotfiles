...
(when (fboundp 'menu-bar-mode) (menu-bar-mode -1))      ; Disable the menu bar atop screen
(when (fboundp 'tool-bar-mode) (tool-bar-mode -1))	; Disable the button bar atop screen
